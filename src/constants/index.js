export const navLinks = [
  ...
  export const calculateSizes = (isSmall, isMobile, isTablet) => {
    const deskScale = isSmall ? 0.05 : isMobile ? 0.06 : 0.03;
    const deskPosition = isMobile ? [0.5, -4.5, 0] : [0.25, -3.1, 13];
  
    const cubePosition = isSmall
      ? [6, -5, 0]
      : isMobile
      ? [8, -5, 0]
      : isTablet
    ...
    const reactLogoPosition = isSmall
      ? [5, 3, 0]
      : isMobile
      ? [8, 7, 0]
      : isTablet
